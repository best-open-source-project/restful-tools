/*
  ...
  作者姓名            修改时间           版本号              描述
 */
package com.github.loren.restful.tools.view.window.frame;
...
import com.github.loren.restful.tools.beans.settings.Settings;
import com.github.loren.restful.tools.service.Notify;
...
import com.github.loren.restful.tools.view.window.RestfulTreeCellRenderer;
...
public class ServiceTree extends JBScrollPane {
    ...
    public void renderRequestTree(@NotNull Map<String, List<Request>> allRequests) {
        ...
        TreeNode<String> root = new TreeNode<>(Bundle.message("service.tree.NotFoundAny"));
    ...
    private void initEvent() {
        ...
        tree.addMouseListener(new MouseAdapter() {
            ...
            private JPopupMenu getClassPopupMenu() {
                ...
                // navigation
                JMenuItem navigation = new JBMenuItem(Bundle.message("action.NavigateToClass.text"), AllIcons.Nodes.Class);
            ...
            private JPopupMenu getModulePopupMenu() {
                ...
                JBMenuItem moduleSetting = new JBMenuItem(Bundle.message("action.OpenModuleSetting.text"), AllIcons.General.Settings);
            ...
            private JPopupMenu getRequestItemPopupMenu() {
                ...
                // navigation
                JMenuItem navigation = new JBMenuItem(Bundle.message("action.NavigateToMethod.text"), AllIcons.Nodes.Method);
                navigation.addActionListener(actionEvent -> {
                    Request request = getTreeNodeRequest(tree);
                    if (request == null) {
                        return;
                ...
                // Copy full url
                JMenuItem copyFullUrl = new JBMenuItem(Bundle.message("action.CopyFullPath.text"), AllIcons.Actions.Copy);
                copyFullUrl.addActionListener(actionEvent -> {
                    ...
                    SystemUtil.Clipboard.copy(SystemUtil.buildUrl(
                            ...
                            contextPath,
                            request.getPath()));
                    Notify.getInstance(project).info(Bundle.message("action.CopyFullPath.success"));
                });

                // Copy api path
                JMenuItem copyApiPath = new JBMenuItem(Bundle.message("action.CopyApi.text"), AllIcons.Actions.Copy);
                copyApiPath.addActionListener(actionEvent -> {
                    ...
                    Notify.getInstance(project).info(Bundle.message("action.CopyApi.success"));
                });
