/*
  ...
  作者姓名            修改时间           版本号              描述
 */
package com.github.loren.restful.tools.actions.dialog;
...
public class CurrClassTreeAction extends AnAction implements TreeOption {
    ...
    public CurrClassTreeAction() {
        ...
        getTemplatePresentation().setText(Bundle.message("action.ShowCurrClassServiceTree.text"));
        getTemplatePresentation().setDescription(Bundle.message("action.ShowCurrClassServiceTree.description"));
    }
