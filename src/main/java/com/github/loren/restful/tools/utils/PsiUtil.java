...
public class PsiUtil {
    ...
    public static Object getDefaultValueOfPsiType(@NotNull PsiType psiType) {
        ...
        // 基本类型|数字
        if (PsiTypes.intType().equals(psiType) || "java.lang.Integer".equals(canonicalText)
                || PsiTypes.byteType().equals(psiType) || "java.lang.Byte".equals(canonicalText)
                || PsiTypes.shortType().equals(psiType) || "java.lang.Short".equals(canonicalText)
