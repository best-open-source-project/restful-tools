package com.github.loren.restful.tools.utils.convert;

import com.github.loren.restful.tools.annotation.SpringHttpMethodAnnotation;
import com.github.loren.restful.tools.utils.JsonUtil;
import com.github.loren.restful.tools.utils.PsiUtil;
...
public class ParamsConvert {
    ...
    private Object getDefaultValue(@Nullable KtExpression expression, @SuppressWarnings("SameParameterValue") boolean keep) {
        switch (expression) {
            ...
            case KtStringTemplateExpression templateExpression -> {
            ...
            case KtCallExpression callExpression -> {
