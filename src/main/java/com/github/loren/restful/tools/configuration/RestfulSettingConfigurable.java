/*
  ...
  作者姓名            修改时间           版本号              描述
 */
package com.github.loren.restful.tools.configuration;

import com.github.loren.restful.tools.utils.Bundle;
import com.github.loren.restful.tools.view.window.options.RestfulSettingWindow;
...
public class RestfulSettingConfigurable implements Configurable {
    ...
    public String getDisplayName() {
        return Bundle.message("setting.configurable.displayName");
    }
