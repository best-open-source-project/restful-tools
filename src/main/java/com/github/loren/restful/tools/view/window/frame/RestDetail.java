...
import com.github.loren.restful.tools.service.topic.RestDetailTopic;
...
import com.github.loren.restful.tools.utils.convert.ParamsConvert;
import com.github.loren.restful.tools.view.components.editor.JsonEditor;
...
public class RestDetail extends JPanel {
    ...
    private void initView() {
        ...
        sendRequest = new JXButton(Bundle.message("http.tool.button.send"));
        ...
        responseTab.setText(Bundle.message("http.tool.tab.response"));
    ...
    private void sendRequest(String url) {
        ...
        Runnable command = () -> {
            ...
            application.invokeLater(() -> responseView.setPlaceholder(Bundle.message("http.tool.running.http")));
            try {
