...
import com.github.loren.restful.tools.configuration.RestfulSetting;
import com.github.loren.restful.tools.utils.SystemUtil;
import com.github.loren.restful.tools.utils.xml.converter.BooleanConverter;
import com.github.loren.restful.tools.utils.xml.converter.IntegerConverter;
import com.github.loren.restful.tools.utils.xml.converter.StringConverter;
import com.github.loren.restful.tools.view.window.options.Option;
import com.github.loren.restful.tools.view.window.options.template.BaseInput;
import com.github.loren.restful.tools.view.window.options.template.CheckBox;
import com.github.loren.restful.tools.view.window.options.template.ComboBox;
import com.github.loren.restful.tools.view.window.options.template.IntegerInput;
import com.github.loren.restful.tools.view.window.options.template.StringInput;
...
public class SettingKey<T> extends Key<T> {
    ...
    public static SettingKey<Boolean> createCheckBox(@NotNull String name,
            @NotNull Boolean defaultData) {
    ...
    public static <T> SettingKey<T> createComboBox(@NotNull String name,
            @NotNull final T[] dataArray, @NotNull Converter<T> converter,
            int... defaultDataIndex) {
        SettingKey<T> settingKey = new SettingKey<>(name,
                dataArray[SystemUtil.Array.getLegalSubscript(
                        dataArray,
                        defaultDataIndex != null && defaultDataIndex.length > 0
                                ? defaultDataIndex[0] : null
                )], converter);
    ...
    @NotNull
    public static SettingKey<String> createInputString(@NotNull String name,
            @NotNull String defaultData, @NotNull BaseInput.Verify<String> verify) {
    ...
    @NotNull
    public static SettingKey<Integer> createInputNumber(@NotNull String name,
            @NotNull Integer defaultData, @NotNull BaseInput.Verify<Integer> verify) {
