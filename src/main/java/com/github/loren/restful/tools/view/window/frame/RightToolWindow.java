...
import com.github.loren.restful.tools.service.topic.RefreshServiceTreeTopic;
import com.github.loren.restful.tools.service.topic.RestDetailTopic;
import com.github.loren.restful.tools.service.topic.ServiceTreeTopic;
import com.github.loren.restful.tools.utils.PomUtil;
import com.github.loren.restful.tools.utils.RequestUtil;
...
public class RightToolWindow extends JPanel {
    ...
    private void initEvent() {
        ...
        project.getMessageBus().connect().subscribe(ServiceTreeTopic.TOPIC, (ServiceTreeTopic) serviceTree::renderRequestTree);
        project.getMessageBus().connect().subscribe(RefreshServiceTreeTopic.TOPIC, (RefreshServiceTreeTopic) this::refreshRequestTree);
    }
